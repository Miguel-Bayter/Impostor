...
export class AuthGateway {
  ...
  async handleRegister(@MessageBody() dto: RegisterDto, @ConnectedSocket() client: Socket): Promise<void> {
    try {
  ...
  async handleLogin(@MessageBody() dto: LoginDto, @ConnectedSocket() client: Socket): Promise<void> {
    try {
