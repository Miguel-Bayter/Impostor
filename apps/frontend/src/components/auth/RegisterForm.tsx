...
const RegisterForm = () => {
  ...
  return (
    <form onSubmit={(e) => void handleSubmit(e)} className="space-y-5">
      ...
      <div className="space-y-2">
        <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wide pl-1">Email</label>
        <div className="relative">
      ...
      <div className="space-y-2">
        <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wide pl-1">Contraseña</label>
        <div className="relative">
