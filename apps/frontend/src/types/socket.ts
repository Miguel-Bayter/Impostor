...
import type { SharedAuthError, SharedAuthResponse, SharedClientToServerEvents, SharedServerToClientEvents } from "@impostor/types";
...
export type SharedServerEvents = SharedServerToClientEvents;
export type SharedClientEvents = SharedClientToServerEvents;
export type SharedAuthSuccessResponse = SharedAuthResponse;
export type SharedAuthErrorResponse = SharedAuthError;
 ...
 * };
 */
export type SocketEventCallback<K extends keyof SocketEvents> = SocketEvents[K] extends void ? () => void : (data: SocketEvents[K]) => void;
